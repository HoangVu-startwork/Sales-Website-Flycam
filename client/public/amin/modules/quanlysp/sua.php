    ...
    ?>
        ...
        <tr>
            ...
            <tr>
                ...
                <td><input type="text" value="<?php echo $row['soluongkho'] ?>" name="soluong" class="soluong"></td>
            </tr>
            <tr>
                <td class="chu">Giá sản phẩm</td>
                <td><input type="text" value="<?php echo $row['gia'] ?>" name="gia" class="giasp"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><textarea rows="5" cols="62" name="noidungkhuyenmai" style="resize: none;"><?php echo html_entity_decode($row['khuyenmai']) ?></textarea></td>
            </tr>
            <tr>
                <td class="chu">Tóm tắt</td>
                <td><textarea id='editor' name="tomtat"><?php echo html_entity_decode($row['tomtac']) ?></textarea></td>
            </tr>
            <tr>
                <td class="chu">Nội dung</td>
                <td><textarea id='noidung' rows="20" cols="92" name="noidung" style="resize: none;"><?php echo html_entity_decode($row['chitiet']) ?></textarea></td>
            </tr>
            <tr>
