...
<body>
<?php
    $sql_lietke_sp = "SELECT * FROM tbl_hoadon WHERE tinhtrang = 1";
...
<table style="width: 100%;" border="1" style="border-collapse: collapse;">
        <tr>
            ...
            <th class="tinhtrang">Tình trạng</th>
        ...
        <tr class="td">
            ...
            <td><?php
                $sql_danhmuc = "SELECT * FROM tbl_tinhtranghoadon ORDER BY id_tinhtrang DESC";
                $query_danhmuc = mysqli_query($mysqli, $sql_danhmuc);
                while($row_danhmuc = mysqli_fetch_array($query_danhmuc)){
                    if($row_danhmuc['id_tinhtrang']==$row['tinhtrang']){
                        ?>
                    <?php echo $row_danhmuc['tentinhtrang'] ?>
                <?php
                }
                }
                ?></td>
             <td>
                <a href="?action=quanlyhoadonchuaduyet&query=sua&idhoadon=<?php echo $row['id_hoadon'] ?>"><input id="nut" type="submit" value="Chi tiết"></a> <br> 
